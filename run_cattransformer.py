...
if __name__ == "__main__":
    ...
    # initialize wandb
    run_name = f"CatTransformer_{args.features}"
    try:
    ...
    model = CatTransformer(
        categories=categories,  # tuple containing the number of unique values (i.e., levels) within each easily encodable category (categories of low cardinality)
        num_high_card_categories=1,  # number of high-cardinality variables whose levels need to be derived from an LM
